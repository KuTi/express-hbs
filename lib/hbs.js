 ...
 */
Koa2Hbs.prototype.block = function(name) {
 ...
 * {{/contentFor}}
 */
Koa2Hbs.prototype.content = function(name, options, context) {
 ...
 */
Koa2Hbs.prototype.layoutPath = function(filename, layout) {
	var dirs,
		layoutPath;
	if (layout[0] === '.') {
 ...
 */
Koa2Hbs.prototype.declaredLayoutFile = function(str, filename) {
 ...
 */
Koa2Hbs.prototype.cacheLayout = function(layoutFile, useCache, cb) {
	var self = this;
 ...
 */
Koa2Hbs.prototype.cachePartials = function(cb) {
	var self = this;
 ...
 * }
 */
Koa2Hbs.prototype.middleware = function(options) {
	var self = this;
 ...
 */
Koa2Hbs.prototype.loadDefaultLayout = function(useCache, cb) {
	var self = this;
 ...
 */
Koa2Hbs.prototype.registerHelper = function(name, fn) {
 ...
 */
Koa2Hbs.prototype.registerPartial = function(name, source, filename) {
 ...
 */
Koa2Hbs.prototype.compile = function(source, filename) {
 ...
 */
Koa2Hbs.prototype.registerAsyncHelper = function(name, fn) {
...
Koa2Hbs.prototype.updateTemplateOptions = function(templateOptions) {
	this._options.templateOptions = templateOptions;
};

/**
 * Creates a new instance of Koa2Hbs.
 */
Koa2Hbs.prototype.create = function() {
	return new Koa2Hbs();
};
 ...
 *       }
 */
Koa2Hbs.prototype.___express = function ___express(filename, source, options, cb) {
